  ...
  var jqxhr = $.getJSON("src/build/json/scores.json", function() {
    ...
    if (getLocale() == "ar") {
      divNextStep.innerHTML =
        "<h2>الخطوات التالية</h2> <p>للمساعدة في رحلتك لتأمين مستقبل آمن ماليًا، تفضل بزيارة  CDA.gov.ae واطلع من مقالاتنا وأدلتنا حول التمويل الشخصي. </p><p>اختر الخيارات التالية لتستلم تقرير كشف الصحة المالية:</p>";
    } else {
      divNextStep.innerHTML =
